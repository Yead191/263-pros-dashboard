        ...
        },
        {
            ...
            render: (_: any, record: any) => (
                <div className="flex items-center gap-3">
                    <button className="" onClick={() => navigate(`/faq/${record.categoryName}`)}>
                        <MdOutlineRemoveRedEye size={20} color="#4b5563" />
                    </button>
                    <button className="" onClick={() => console.log('Add FAQ for:', record.categoryName)}>
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-8">
                ...
                <button
                    className="flex items-center gap-2 text-white bg-[#055E6E] border-0 h-[45px] px-6 rounded font-medium"
